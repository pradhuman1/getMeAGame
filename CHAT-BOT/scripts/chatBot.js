...
var smallCard = false;
var Data;
var gameName=[{name:"Portal 2",slug:"portal-2"},{name:"Portal",slug:"portal"},{name:"Grand Theft Auto V",slug:"grand-theft-auto-v"}];
...
function closeAllLists(el){
    if(el!==inputtxt)
    document.querySelector('.sugg-area').innerHTML="";
}
