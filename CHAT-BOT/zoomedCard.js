        ...
        if(globalData){
            ...
            function modifyCard(game){
                ...
                game.platforms.forEach((curr)=>{
                    ...
                    html = html.replace("%platformName%",curr.platform.name);
            ...
            function displayPreview(starting){
                ...
                for(var i=starting;i<(starting+4)&&videoImage.length;i++){
                    if(i===0)
                    html = '<div class="preview-card" ><img src="./video-placeholder.jpg" width="128px" height="98px"  id="video"></div>';
